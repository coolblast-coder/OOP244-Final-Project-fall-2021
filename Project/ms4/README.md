...
- If the incoming argument is a console IO object.
   ...
   - prints the author's name in SDDS_AUTHOR_WIDTH spaces. If the author's name is longer than the SDDS_AUTHOR_WIDTH value, it will cut it short and prints exactly  SDDS_AUTHOR_WIDTH characters. Note that this should now modify the author's name.
   - prints ```" |"```
...
Then if the incoming istream object is not is a fail state, dynamically hold the author's name in the char pointer attribute of the book class.
